...
SOURCE_EXCLUDE = r'^/(?!trump$)(?!clinton$)(?!tsarnaev$)(?!terrorist$)$'  # Source tweets that match this regexp will not be added to the Markov chain. You might want to filter out inappropriate words for example.
